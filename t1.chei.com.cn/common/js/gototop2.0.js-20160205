...
CreatGoToTop.prototype ={
    ...
    goToTop : function(width,h_url){
        ...
        var temp ="";
        if(this.url!=''){
            temp += '<div id="newsCommentBar" style="'+this.cssText+'"><a title="返回首页" href="'+this.url+'" class="link_home" style="display:block; width:55px;height:45px; color:#858585; background:url(http://t4.chei.com.cn/common/images/go-top.png) 0 -128px no-repeat ; margin-bottom:5px;padding-top:9px;text-align:center;font-size:12px;line-height:18px;text-decoration:none;">返回<br/>首页</a><a title="返回顶部" href="javascript:;" id="'+this.ctid+'" style="width:55px; height:54px;background:url(http://t4.chei.com.cn/common/images/go-top.png) 0 0 no-repeat ; display:none;"></a></div>';
        }else{
            temp += '<div id="newsCommentBar" style="'+this.cssText+'"><a title="返回顶部" href="javascript:;" id="'+this.ctid+'" style="width:55px; height:54px;background:url(http://t4.chei.com.cn/common/images/go-top.png) no-repeat 0 0 ; display:none;"></a></div>';
        }
